...
const Address = () => {
  ...
  return (
    <div className="signup-cover h-screen lg:py-9 py-4">
      <Header />
      <div className="flex items-center lg:justify-end justify-center lg:py-0 py-16 ">
        <div>
            ...
            <div className="bg-white p-5 rounded-lg mt-8">
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="text-center pt-3">
                  <button className="btn lg:btn-lg bg-[#50b948] text-white font-bold uppercase px-20">
                    Next
                  </button>
                </div>
              </form>
